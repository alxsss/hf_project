...
<?php $status=sfGuardUserStatusPeer::retrieveByPk($status_id); 
$comments=$status->getsfGuardUserStatusCommentsJoinsfGuardUser()?>
    ...
    <div class="comment_text">
	  ...
	  <?php if($user_id==$status->getUserId()||$user_id==$comment->getUserId()):?> 
	    <div class="delete_item">
          <?php  echo link_to(__('Delete'), '@delete_status_comment?id='.$comment->getId()) ?> 
	    </div>		  
     <?php endif;?>
   </div>
  </div>
