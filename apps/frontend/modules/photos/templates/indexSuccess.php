...
<div id="right_column_user">
  <div class="friends_to_be_invited">
   ...
   <?php echo __('sort by')?>:
      ...
      <?php echo link_to(__('rate'), 'photos/index?sort=rating&type='.($sf_user->getAttribute('type', 'asc', 'photo/sort') == 'asc' ? 'desc' : 'asc')) ?>
      (<?php echo __($sf_user->getAttribute('type', 'asc', 'photo/sort')) ?>)
      <?php else: ?>
      <?php echo link_to(__('rate'), 'photos/index?sort=rating&type=asc') ?>
      <?php endif; ?>   
	  |
	  <?php if ($sf_user->getAttribute('sort', null, 'photo/sort') == 'created_at'): ?>
      <?php echo link_to(__('date'), 'photos/index?sort=created_at&type='.($sf_user->getAttribute('type', 'asc', 'photo/sort') == 'asc' ? 'desc' : 'asc')) ?>
      (<?php echo __($sf_user->getAttribute('type', 'asc', 'photo/sort')) ?>)
      <?php else: ?>
      <?php echo link_to(__('date'), 'photos/index?sort=created_at&type=asc') ?>
      <?php endif; ?>
</div>	
    ...
    <?php foreach ($popular_photos->getResults() as $popular_photo): ?>
      ...
      <div class="user_friend">
        <a href="<?php echo url_for('photos/shownew?id='.$popular_photo->getId())?>">
...
<div class="pagination">
  <div id="photos_pager">
    <?php echo pager_navigation($popular_photos, '@photos') ?>
  </div>
</div>
<?php endif;?>
</div>
