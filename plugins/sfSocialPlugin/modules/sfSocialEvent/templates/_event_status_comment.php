...
<?php $status=EventStatusPeer::retrieveByPk($status_id); 
$comments=$status->getEventStatusCommentsJoinsfGuardUser()?>
...
<?php foreach ($comments as $comment): ?>
  <div class="comments">
    ...
    <div class="comment_text">
	  ...
	  <?php if($user_id==$status->getsfSocialEvent()->getUserAdmin()||$user_id==$comment->getUserId()):?> 
