...
<div class="pic">
  <?php echo image_tag(sfConfig::get('app_sf_social_pic_path', '/uploads/sf_social_pics/') . $profile->getPhoto()) ?>
</div>
<?php endif ?>
...
<ul class="attrs">
  ...
  <li><?php echo __('E-mail', null, 'sfSocial') ?>: <?php echo mail_to($user->getEmail(), '', 'encode=true') ?></li>
  ...
  <li><?php echo __('Location', null, 'sfSocial') ?>: <?php echo $profile->getCity() ?></li>
</ul>
