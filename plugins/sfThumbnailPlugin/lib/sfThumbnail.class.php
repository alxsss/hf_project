...
class sfThumbnail
{
   ...
   */
  public function __construct($maxWidth = null, $maxHeight = null, $scale = true, $inflate = true, $quality = 180, $adapterClass = null, $adapterOptions = array())
  {
    if (!$adapterClass)
    {
  ...
  */
  ...
  public function convert($thumbDest, $targetMime = null)
  {
    $this->adapter->convert($this, $thumbDest, $targetMime);
  }
  ...
  public function initThumb($sourceWidth, $sourceHeight, $maxWidth, $maxHeight, $scale, $inflate)
  {
    ...
    {
      $this->thumbWidth = $sourceWidth;
      $this->thumbHeight =$sourceHeight;
    }*/
