...
$games_language[0] = "Play a game";
$games_language[1] = "Please select a game";
$games_language[2] = "Which game would you like to play?";
$games_language[3] = "has sent you a game request.";
$games_language[4] = "Click here to accept it";
$games_language[5] = " or simply ignore this message.";
$games_language[6] = "has successfully sent a game request.";
$games_language[7] = "Game request sent!";
$games_language[8] = "Which game would you like to play?";
$games_language[9] = "User has been sent game request successfully. You should receive a reply shortly. Closing window.";
$games_language[10] = "has accepted your game request.";
$games_language[11] = "Click here to launch the game window";
$games_language[12] = "Playing Game!";
$games_language[13] = <<<EOD
