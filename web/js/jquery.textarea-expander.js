 ...
 *
 * From JavaScript, use:
 *     jQuery(<node>).TextAreaExpander(<minHeight>, <maxHeight>);
 *     where:
...
(function(jQuery) {
	...
	jQuery.fn.TextAreaExpander = function(minHeight, maxHeight) {
		...
		function showCommentButton(){
			//jQuery('.submit-row').removeClass('show-comment');
            //jQuery(this).next().addClass('show-comment');
...
jQuery(document).ready(function() {
	...
	/*jQuery('.comment_status').click(function(e){
	  e.preventDefault(); 
	  jQuery(this).closest('.expand').css('background', 'red');
											 });*/
